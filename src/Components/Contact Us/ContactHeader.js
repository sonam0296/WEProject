...
const ContactHeader = () => {
    return (
        ...
        {/* Background Image */}
            {/* Top NavBar */}
            <div className="top-head" style={{marginRight:"130px", marginTop:"50px"}}>
                <ul>
            ...
            {/* <div className="main-shape"></div> */}
                    ...
                    <nav className="navbar navbar-expand-lg custom_container" style={{marginTop:"100px", marginRight:"130px"}}>
